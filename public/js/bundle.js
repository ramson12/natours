...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFyaWExMiIsImEiOiJjazU1bjA1NXIwMjQ0M2xxZm8zNWZlejltIn0.7qVczRvp3B-MIyuV4-gxXg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>\n        Day ".concat(loc.dat, ": ").concat(loc.description, "\n      </p>")).addTo(map); //extends map bounds to include current location
...
var stripe = Stripe('pk_test_dL50JAJksjPJmzcuBb7YMviX00WxWgn559');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9254" + '/');
